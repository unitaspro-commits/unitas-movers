...
<p><strong>Key differences from Calgary:</strong> Edmonton has a more grid-based layout, the LRT system covers different corridors, and the river valley parkland system is one of North America\'s largest urban park networks. Winter can be noticeably colder than Calgary, so factor in heated storage if your move spans multiple days in winter.</p>',
                ...
                'seasonal_tips' => 'Winter moves on Highway 2 can encounter blowing snow between Olds and Red Deer. Trucks carry winter tires Nov-Mar. Summer moves benefit from 16+ hours of daylight for flexible scheduling.',
                ...
                'road_conditions_note' => 'Highway 2 is a divided 4-lane highway in excellent condition. Watch for construction zones near Gasoline Alley (Red Deer) in summer. Crosswinds can be strong between Carstairs and Olds.',
                'notable_stops' => 'Airdrie, Crossfield, Carstairs, Didsbury, Olds, Innisfail, Red Deer, Lacombe, Ponoka, Wetaskiwin, Leduc',
...
<p><strong>What to expect:</strong> Red Deer has a smaller-city feel with excellent parks, the Red Deer River valley, and lower cost of living than Calgary. Many new residents commute to either Calgary or Edmonton for work while enjoying Red Deer\'s quality of life.</p>',
                ...
                'highway_name' => 'Queen Elizabeth II Highway (Highway 2)',
                'highway_number' => 'Highway 2',
                'seasonal_tips' => 'This shorter route is manageable year-round. Winter conditions are usually milder than the full Calgary-Edmonton run. Summer construction near Gasoline Alley can add 15-20 minutes.',
                'fuel_cost_estimate' => 60,
                'popular_move_months' => 'Peak: May-Sep, Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$340,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,100'],
                'road_conditions_note' => 'Divided 4-lane highway, well maintained. Occasional fog in low-lying areas near Innisfail during fall mornings. Speed enforcement is active between Didsbury and Olds.',
                'notable_stops' => 'Airdrie, Crossfield, Carstairs, Didsbury, Olds, Innisfail',
                'backhaul_discount' => true,
                'elevation_change' => '1,045m → 846m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 2,
            ],
...
<p><strong>Key considerations:</strong> Lethbridge is notably windy — the coulees channel wind through the city. Housing is significantly more affordable than Calgary, and the city offers excellent pathways, parks, and a surprisingly strong food and arts scene.</p>',
                ...
                'highway_name' => 'Highway 2 South / Highway 3',
                'highway_number' => 'Highway 2/3',
                'seasonal_tips' => 'Southern Alberta is prone to strong chinook winds in winter that can gust over 100 km/h. Spring moves should plan for muddy rural roads near Lethbridge. Summer is ideal with warm, dry conditions.',
                'fuel_cost_estimate' => 85,
                'popular_move_months' => 'Peak: May-Aug, Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$310,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,050'],
                'road_conditions_note' => 'Highway 2 south is a well-maintained divided highway. The final stretch through the Oldman River valley into Lethbridge has steep grades. Strong crosswinds are common on open prairie sections near Fort Macleod.',
                'notable_stops' => 'Okotoks, High River, Nanton, Claresholm, Fort Macleod',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 910m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 3,
            ],
...
<p><strong>Why people move here:</strong> Incredibly low utility costs (the city owns its gas reserves), affordable housing, warm summers, and a relaxed pace of life. Medicine Hat has invested heavily in its downtown and parks in recent years.</p>',
                ...
                'seasonal_tips' => 'The Trans-Canada can experience icy conditions and ground blizzards in winter, especially near Strathmore and Brooks. Summer moves are straightforward but plan for heat — Medicine Hat regularly exceeds 35°C in July/August.',
                'fuel_cost_estimate' => 120,
                'popular_move_months' => 'Peak: May-Sep, Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$290,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,100'],
                'road_conditions_note' => 'Trans-Canada is a divided highway for most of this route. Long straight stretches through open prairie mean crosswinds and wildlife hazards, especially near dawn/dusk. Limited services between Brooks and Medicine Hat.',
                'notable_stops' => 'Strathmore, Bassano, Brooks, Suffield',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 717m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 4,
            ],
...
<p><strong>What to expect:</strong> Grande Prairie offers affordable housing with a small-city feel. The Muskoseepi Park system is extensive, the Eastlink Centre provides recreation, and the city has a surprisingly diverse food scene. Winters are long and cold, but summers feature almost 24 hours of daylight.</p>',
                ...
                'highway_name' => 'Highway 2 North / Highway 43',
                'highway_number' => 'Highway 2/43',
                'seasonal_tips' => 'This is a long day drive. Winter conditions north of Edmonton on Highway 43 can be severe with black ice and heavy snow. Plan for a two-day move in winter. Summer moves benefit from extended daylight but watch for agricultural equipment on Highway 43.',
                'fuel_cost_estimate' => 290,
                'popular_move_months' => 'Peak: Apr-Sep (oil & gas schedules), Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$320,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,200'],
                'road_conditions_note' => 'Highway 2 to Edmonton is excellent. Highway 43 west of Whitecourt is mostly 2-lane with passing lanes — slower going behind semis. Road conditions deteriorate significantly in winter north of Whitecourt.',
                'notable_stops' => 'Red Deer, Edmonton, Spruce Grove, Edson, Whitecourt, Fox Creek, Valleyview',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 669m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 5,
            ],
...
<p><strong>Key considerations:</strong> Housing costs can be high relative to the city\'s size due to oil sands demand. Winters are long and cold with short days. However, high wages, a strong community spirit (forged through the 2016 wildfire recovery), and excellent recreation facilities make Fort McMurray home for thousands of families.</p>',
                ...
                'highway_name' => 'Highway 2 North / Highway 63',
                'highway_number' => 'Highway 2/63',
                'seasonal_tips' => 'Fort McMurray moves are heavily influenced by oil sands schedules. Highway 63 can be dangerous in winter — icy, single-lane stretches with heavy truck traffic. Summer moves are strongly preferred. Spring breakup (March-April) creates mud and road weight restrictions.',
                'fuel_cost_estimate' => 300,
                'popular_move_months' => 'Peak: Apr-Oct (oil & gas rotations), Off-peak: Dec-Feb',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$340,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,300'],
                'road_conditions_note' => 'Highway 63 north of Athabasca is notorious for heavy oilfield truck traffic and winter accidents. Twinning improvements have helped but single-lane sections remain. Carry emergency supplies for the remote stretch.',
                'notable_stops' => 'Red Deer, Edmonton, Athabasca, Wandering River, Mariana Lake',
                'backhaul_discount' => true,
                'elevation_change' => '1,045m → 369m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 6,
            ],
...
<p><strong>What to expect:</strong> Canmore offers unmatched mountain access — hiking, skiing, mountain biking, and climbing are out your door. Housing is more expensive than Calgary due to limited supply in the Bow Valley. The town has a vibrant food, arts, and wellness scene, plus a strong sense of community.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway (Highway 1)',
                'highway_number' => 'Highway 1',
                'seasonal_tips' => 'Mountain weather changes rapidly. Winter moves require winter tires (mandatory Oct 1 - Apr 30 on mountain highways). Avalanche control can close the highway. Summer weekends see heavy Banff-bound traffic — schedule departure before 7 AM or after 6 PM.',
                'fuel_cost_estimate' => 45,
                'popular_move_months' => 'Peak: May-Sep (lifestyle movers), Steady year-round',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$850,000', 'dominant_type' => 'Condos & townhouses', 'avg_sqft' => '950'],
                'road_conditions_note' => 'Trans-Canada is a divided 4-lane highway through the foothills with mountain grades. Watch for wildlife on the highway, especially elk near Canmore. Speed reduced to 90 km/h in construction zones and near Deadman\'s Flats.',
                'notable_stops' => 'Cochrane, Kananaskis, Deadman\'s Flats',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 1,309m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 7,
            ],
...
<p><strong>Lifestyle:</strong> Unparalleled access to world-class skiing (Sunshine, Lake Louise, Norquay), hiking, hot springs, and mountain culture. The town is small but walkable, with excellent restaurants, shops, and a global community of outdoor enthusiasts.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway (Highway 1)',
                'highway_number' => 'Highway 1',
                'seasonal_tips' => 'Parks Canada restricts moving truck access in summer peak season. Book early for June-August moves. Winter tires are mandatory. Avalanche closures can delay moves by hours — always have a backup date for winter moves.',
                'fuel_cost_estimate' => 55,
                'popular_move_months' => 'Peak: Sep-Oct (shoulder season), Apr-May (pre-season)',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$650,000', 'dominant_type' => 'Apartments & staff housing', 'avg_sqft' => '650'],
                'road_conditions_note' => 'Same mountain highway conditions as Canmore route. Within Banff townsite, streets are narrow and parking is extremely limited. Coordinate with Parks Canada for loading zones. Speed limit drops to 70 km/h inside the park.',
                'notable_stops' => 'Cochrane, Canmore, Deadman\'s Flats',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 1,383m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 8,
            ],
...
<p><strong>Why Airdrie:</strong> More home for your money, newer schools, excellent sports and recreation facilities, a growing commercial base, and the CrossIron Mills shopping centre between Airdrie and Calgary. The tradeoff is a 20-40 minute commute to most Calgary workplaces.</p>',
                ...
                'highway_name' => 'Queen Elizabeth II Highway (Highway 2)',
                'highway_number' => 'Highway 2',
                'seasonal_tips' => 'This short route is easy year-round. Winter moves just need extra time for ice on residential streets. Summer moves should plan around Airdrie\'s many new-build closing dates — book 2-3 weeks in advance during June-August.',
                'fuel_cost_estimate' => 15,
                'popular_move_months' => 'Peak: Jun-Aug (new home closings), Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$460,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,300'],
                'road_conditions_note' => 'Quick 20-minute highway drive on divided 4-lane. Traffic on Highway 2 between Calgary and Airdrie is heavy during rush hours. Use Deerfoot or Stoney Trail connectors to avoid Beddington/Country Hills interchange congestion.',
                'notable_stops' => 'Balzac, CrossIron Mills area',
                'backhaul_discount' => true,
                'elevation_change' => '1,045m → 1,082m (slight ascent)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 9,
            ],
...
<p><strong>Why Cochrane:</strong> Mountain views, a genuine small-town main street, newer homes at lower prices than Calgary\'s west side, and a strong family community. The famous Mackay\'s Ice Cream is just the start of Cochrane\'s charm. The commute to west Calgary is typically 25-35 minutes.</p>',
                ...
                'seasonal_tips' => 'Cochrane is 100m higher than Calgary and often catches early snowfall. The ranch lands between Calgary and Cochrane see strong westerly winds. Summer moves are ideal — the countryside drive is scenic and quick.',
                'fuel_cost_estimate' => 15,
                'popular_move_months' => 'Peak: May-Sep, Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$520,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,400'],
                'road_conditions_note' => 'Highway 1A is a scenic 2-lane road through ranch land. Can be narrow and winding in sections. Highway 22 connection is straightforward. Watch for horse trailers and agricultural vehicles on the road.',
                'notable_stops' => 'Bearspaw, Cochrane town centre',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 1,152m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 10,
            ],
...
<p><strong>Why Okotoks:</strong> Award-winning schools, a walkable historic downtown, extensive pathways, and a genuine small-town community. Drake Landing is internationally recognized for its solar district heating system — a draw for environmentally conscious families.</p>',
                ...
                'seasonal_tips' => 'Short and easy year-round. Okotoks occasionally restricts water connections for new builds — confirm utility hookups before scheduling your move. Summer weekends see tourist traffic to the Okotoks Erratic (Big Rock).',
                'fuel_cost_estimate' => 20,
                'popular_move_months' => 'Peak: Jun-Aug, Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$500,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,350'],
                'road_conditions_note' => 'Highway 2A is a well-maintained 2-lane road. Light traffic most of the time. Watch for speed traps through De Winton. The Sheep River crossing into Okotoks can ice up in early winter.',
                'notable_stops' => 'De Winton, Heritage Pointe',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 1,048m (essentially flat)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 11,
            ],
...
<p><strong>Why Chestermere:</strong> Lake access, newer homes, and extremely close proximity to Calgary for commuting. Lakefront properties command premium prices, but homes further from the lake are competitively priced with Calgary\'s east-side suburbs.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway / Highway 791',
                'highway_number' => 'Highway 1/791',
                'seasonal_tips' => 'The shortest route we offer. Year-round easy moving. Spring can bring strong winds off Chestermere Lake. New-build communities on the east side have muddy roads during spring thaw before full paving is complete.',
                'fuel_cost_estimate' => 10,
                'popular_move_months' => 'Peak: Jun-Sep (lakeside lifestyle), Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$530,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,450'],
                'road_conditions_note' => 'Quick 15-minute drive east on the Trans-Canada then south on 791. Traffic on Highway 1 east of Calgary is steady but fast-moving. Watch for new subdivision construction detours on Chestermere\'s eastern edge.',
                'notable_stops' => 'East Calgary industrial area, Chestermere Lake',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 1,020m (slight descent)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 12,
            ],
...
<p><strong>What to expect:</strong> A milder, rainier climate than Calgary with virtually no chinooks. Vancouver\'s condo market dominates the housing stock in the city proper, while the suburbs offer more single-family options. The cost of living is significantly higher than Calgary across nearly every category.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway (Highway 1)',
                'highway_number' => 'Highway 1',
                'seasonal_tips' => 'Mountain passes (Rogers Pass, Kicking Horse Pass) require winter tires Oct-Apr and can close for avalanche control. Budget a 2-day move minimum. Summer is peak season — book 3-4 weeks ahead. Check DriveBC for pass conditions before departure.',
                'fuel_cost_estimate' => 420,
                'popular_move_months' => 'Peak: Jun-Sep, Off-peak: Nov-Mar (weather risk)',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$1,150,000', 'dominant_type' => 'Condos & apartments', 'avg_sqft' => '850'],
                'road_conditions_note' => 'Multiple mountain passes with steep grades (6-8%). Rogers Pass and Kicking Horse Pass are the most challenging sections. Mandatory chain-up areas in BC for commercial vehicles in winter. Well-maintained but weather-dependent.',
                'notable_stops' => 'Canmore, Golden, Revelstoke, Kamloops, Hope',
                'backhaul_discount' => true,
                'elevation_change' => '1,045m → 0m (sea level, with multiple mountain pass climbs)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 13,
            ],
...
<p><strong>What to expect:</strong> Significantly milder winters than Calgary with hot, dry summers. Housing prices have risen sharply but remain below Vancouver levels. The lake lifestyle is the major draw — boating, beaches, and wine country are daily realities. The city also has a growing tech hub and strong healthcare sector.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway / Highway 97C (Okanagan Connector)',
                'highway_number' => 'Highway 1/97C',
                'seasonal_tips' => 'The Okanagan Connector (Highway 97C) is a high-altitude mountain highway that can be treacherous in winter. Summer moves coincide with wine tourism traffic through the Okanagan. Book early for July-August moves.',
                'fuel_cost_estimate' => 240,
                'popular_move_months' => 'Peak: May-Sep (retirement/lifestyle moves), Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$620,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,100'],
                'road_conditions_note' => 'Mountain highway with several passes. The Okanagan Connector (Hwy 97C) summit reaches 1,728m and is one of BC\'s highest highways. Winter conditions can be extreme. Well-maintained but snow-prone from October to April.',
                'notable_stops' => 'Canmore, Golden, Revelstoke, Merritt, Peachland',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 344m (via 1,728m summit)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 14,
            ],
...
<p><strong>What to expect:</strong> Colder winters than Calgary without the chinook relief, but a strong arts and food scene, affordable housing, and friendly people. Saskatoon\'s riverbank pathway system is excellent and the city has invested heavily in its downtown.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway / Highway 11',
                'highway_number' => 'Highway 1/11',
                'seasonal_tips' => 'Open prairie driving means extreme winter conditions — blowing snow can reduce visibility to zero. Summer moves are straightforward but long. Plan for a full-day move with early morning departure. Saskatchewan Highway 11 can be monotonous — driver fatigue is a real concern.',
                'fuel_cost_estimate' => 250,
                'popular_move_months' => 'Peak: May-Sep, Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$330,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,050'],
                'road_conditions_note' => 'Long, straight prairie highway. Saskatchewan sections can be rough with frost heaves and limited services. Cell coverage is spotty between Medicine Hat and Swift Current. Moose and deer hazards at dawn/dusk.',
                'notable_stops' => 'Medicine Hat, Swift Current, Moose Jaw, Regina (if taking southern route), Rosetown',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 482m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 15,
            ],
...
<p><strong>What to expect:</strong> Small-city living with affordable housing and a strong community. The city has good recreation facilities, a growing commercial sector, and the unique novelty of straddling two provinces. Winters are cold and long, typical of the central prairies.</p>',
                ...
                'highway_name' => 'Highway 2 / Yellowhead Highway (Highway 16)',
                'highway_number' => 'Highway 2/16',
                'seasonal_tips' => 'Highway 16 east of Edmonton is flat and exposed — winter ground blizzards are a major hazard. Summer moves are ideal. Lloydminster straddles the AB/SK border — confirm which province your new address is in for insurance and licensing purposes.',
                'fuel_cost_estimate' => 195,
                'popular_move_months' => 'Peak: Apr-Oct (oil & gas related), Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$260,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,100'],
                'road_conditions_note' => 'Highway 2 to Edmonton is excellent. Highway 16 east is a major trucking corridor but mostly 2-lane with passing sections. Heavy oilfield truck traffic. Road surface can be rough in Saskatchewan sections.',
                'notable_stops' => 'Red Deer, Edmonton, Vegreville, Vermilion',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 668m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
...
<p><strong>What to expect:</strong> Small-city prairie living with an international flavour. Brooks experiences hot, dry summers and cold winters typical of the southern Alberta prairies. The community is welcoming and the cost of living is significantly lower than Calgary.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway (Highway 1)',
                'highway_number' => 'Highway 1',
                'seasonal_tips' => 'Open prairie route with strong crosswinds year-round. Summer temperatures can exceed 35°C — protect temperature-sensitive items. Winter moves face blowing snow risk between Strathmore and Brooks.',
                'fuel_cost_estimate' => 75,
                'popular_move_months' => 'Peak: Apr-Sep, Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'dest_housing_data' => ['avg_price' => '$235,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,000'],
                'road_conditions_note' => 'Divided Trans-Canada highway through flat prairie. Monotonous driving with limited services between Strathmore and Brooks. Strong crosswinds affect high-profile vehicles. Rattlesnake season (May-Sep) — watch when unloading near coulees.',
                'notable_stops' => 'Strathmore, Bassano',
                'backhaul_discount' => false,
                'elevation_change' => '1,045m → 757m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 17,
            ],
        ...
        foreach ($routes as $data) {
            Route::updateOrCreate(['slug' => $data['slug']], $data);
        }
    }
}
