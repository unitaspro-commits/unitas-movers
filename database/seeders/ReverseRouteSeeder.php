...
<p><strong>Key differences from Edmonton:</strong> Calgary sits at a higher elevation with chinook winds that break up winter cold spells. The C-Train LRT connects north-south and east-west. Proximity to Banff and the Rockies (90 minutes) is a major lifestyle draw.</p>',
                ...
                'seasonal_tips' => 'Southbound Highway 2 can be icy through the Red Deer corridor in winter. Edmonton departures in winter should start mid-morning after road crews have treated the highway. Summer moves benefit from early starts to beat Calgary arrival traffic.',
                'fuel_cost_estimate' => 120,
                'popular_move_months' => 'Peak: Jun-Aug, Value: Oct-Feb',
                'origin_housing_data' => ['avg_price' => '$380,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,050'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Southbound Highway 2 is well-maintained divided highway. Heavier traffic approaching Calgary from Airdrie south. The climb from Edmonton\'s river valley adds 375m elevation over the 300 km route.',
                'notable_stops' => 'Leduc, Wetaskiwin, Ponoka, Lacombe, Red Deer, Innisfail, Olds, Didsbury, Carstairs, Crossfield, Airdrie',
                'backhaul_discount' => true,
                'elevation_change' => '668m → 1,045m (ascending)',
...
<p><strong>What to expect:</strong> Calgary has a faster pace than Red Deer with more employment options, dining, entertainment, and cultural offerings. Housing costs are higher but the range of neighbourhoods means options at many price points.</p>',
                ...
                'highway_name' => 'Queen Elizabeth II Highway (Highway 2)',
                'highway_number' => 'Highway 2',
                'seasonal_tips' => 'A quick 90-minute drive that\'s manageable year-round. Watch for freezing rain in the transition zone between Red Deer and Olds. Summer weekends see recreational traffic heading to Kananaskis.',
                'fuel_cost_estimate' => 60,
                'popular_move_months' => 'Peak: May-Sep, Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$340,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,100'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Smooth divided highway heading south. Traffic increases significantly south of Carstairs as you approach the Calgary commuter belt. Use Stoney Trail to reach NW/SW Calgary destinations and avoid Deerfoot.',
                'notable_stops' => 'Innisfail, Olds, Didsbury, Carstairs, Crossfield, Airdrie',
                'backhaul_discount' => true,
                'elevation_change' => '846m → 1,045m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 19,
            ],
...
<p><strong>Key considerations:</strong> Calgary\'s chinook winds make winters milder than Lethbridge\'s persistent wind. Housing costs are higher but wages tend to be higher too, especially in energy, tech, and professional services.</p>',
                ...
                'highway_name' => 'Highway 3 / Highway 2 North',
                'highway_number' => 'Highway 2/3',
                'seasonal_tips' => 'Northbound from Lethbridge means climbing out of the river valley — heavy loads feel the grade. Chinook winds are strongest in the Lethbridge-Fort Macleod corridor. Spring moves may encounter muddy ranch roads near Nanton.',
                'fuel_cost_estimate' => 85,
                'popular_move_months' => 'Peak: May-Aug, Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$310,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,050'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'The climb out of the Oldman River valley is steep for loaded trucks. Open prairie sections between Fort Macleod and Nanton are exposed to crosswinds. Highway 2 north of High River is excellent divided highway.',
                'notable_stops' => 'Fort Macleod, Claresholm, Nanton, High River, Okotoks',
                'backhaul_discount' => false,
                'elevation_change' => '910m → 1,045m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 20,
            ],
...
<p><strong>What to expect:</strong> Higher housing costs than Medicine Hat, but more job opportunities and urban amenities. Calgary\'s chinook winds and proximity to mountain recreation are major lifestyle perks.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway (Highway 1)',
                'highway_number' => 'Highway 1',
                'seasonal_tips' => 'Westbound on the Trans-Canada means driving into prevailing winds, which increases fuel consumption for loaded trucks. Morning fog is common near the Bow River valley between Bassano and Calgary. Summer heat in Medicine Hat means packing early.',
                'fuel_cost_estimate' => 130,
                'popular_move_months' => 'Peak: May-Sep, Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$290,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,100'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Westbound Trans-Canada is a long, gradual ascent from 717m to 1,045m. Headwinds increase fuel costs for loaded trucks. Limited services between Medicine Hat and Brooks. Well-maintained divided highway throughout.',
                'notable_stops' => 'Suffield, Brooks, Bassano, Strathmore',
                'backhaul_discount' => false,
                'elevation_change' => '717m → 1,045m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 21,
            ],
...
<p><strong>What to expect:</strong> Shorter, milder winters with chinooks, more entertainment and dining options, and a significantly larger city to explore. Housing costs are higher but the variety of neighbourhoods provides options at many price points.</p>',
                ...
                'highway_name' => 'Highway 43 / Highway 2 South',
                'highway_number' => 'Highway 43/2',
                'seasonal_tips' => 'Leave Grande Prairie early — this is a full-day drive minimum. Highway 43 east of Grande Prairie is 2-lane through boreal forest with limited cell coverage. Winter moves should budget 2 days with an overnight in Edmonton.',
                'fuel_cost_estimate' => 290,
                'popular_move_months' => 'Peak: Apr-Sep (oil & gas schedules), Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$320,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,200'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Highway 43 is mostly 2-lane with passing lanes. Heavy oilfield and logging truck traffic. Road surface deteriorates in the Whitecourt-Fox Creek corridor. Once on Highway 2 south of Edmonton, conditions are excellent.',
                'notable_stops' => 'Valleyview, Fox Creek, Whitecourt, Edson, Spruce Grove, Edmonton, Red Deer',
                'backhaul_discount' => false,
                'elevation_change' => '669m → 1,045m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 22,
            ],
...
<p><strong>What to expect:</strong> Significantly shorter, warmer winters with chinook relief. More career diversification options. Housing may cost less per square foot than Fort McMurray depending on the neighbourhood you choose.</p>',
                ...
                'highway_name' => 'Highway 63 / Highway 2 South',
                'highway_number' => 'Highway 63/2',
                'seasonal_tips' => 'Most Fort McMurray departures coincide with job relocations — expect emotional moves and time pressure. Highway 63 south is heavily trafficked by oilsands equipment. Spring breakup (Mar-Apr) means road restrictions. Summer is the only recommended season.',
                'fuel_cost_estimate' => 300,
                'popular_move_months' => 'Peak: Apr-Oct (industry layoff cycles), Off-peak: Dec-Feb',
                'origin_housing_data' => ['avg_price' => '$340,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,300'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Highway 63 southbound is the only route out — no alternatives if closed. Heavy oilfield traffic, especially oversized loads. Budget extra time. Once past Athabasca, conditions improve dramatically on Highway 2 south.',
                'notable_stops' => 'Mariana Lake, Wandering River, Athabasca, Edmonton, Red Deer',
                'backhaul_discount' => true,
                'elevation_change' => '369m → 1,045m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 23,
            ],
...
<p><strong>What to expect:</strong> More housing options and lower prices than Canmore. Calgary\'s chinook winds keep winters manageable. The trade-off is less daily mountain access, but weekend trips to Canmore and Banff are easy.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway (Highway 1)',
                'highway_number' => 'Highway 1',
                'seasonal_tips' => 'Eastbound from Canmore is mostly downhill — easier on loaded trucks than the westbound climb. Watch for wildlife on the highway, especially elk at dawn. Weekend afternoon traffic from Banff/Canmore into Calgary can be heavy May-September.',
                'fuel_cost_estimate' => 40,
                'popular_move_months' => 'Peak: Sep-Nov (end of mountain season), Steady year-round',
                'origin_housing_data' => ['avg_price' => '$850,000', 'dominant_type' => 'Condos & townhouses', 'avg_sqft' => '950'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Downhill grade from Canmore into the foothills. Loaded trucks should use engine braking on the descent near Lac des Arcs. Kananaskis turnoff area can be congested on summer weekends. Smooth highway once past Cochrane.',
                'notable_stops' => 'Deadman\'s Flats, Kananaskis, Cochrane',
                'backhaul_discount' => false,
                'elevation_change' => '1,309m → 1,045m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 24,
            ],
...
<p><strong>What to expect:</strong> More space, more affordability, and more career options. Banff remains just 90 minutes away for weekend skiing, hiking, and mountain culture. Calgary\'s urban amenities — restaurants, shopping, arts — are a significant upgrade.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway (Highway 1)',
                'highway_number' => 'Highway 1',
                'seasonal_tips' => 'Leaving Banff townsite with a moving truck requires early-morning scheduling to avoid tourist traffic. Parks Canada may require advance notice for large vehicles. The descent from the park is fuel-efficient but braking-intensive for heavy loads.',
                'fuel_cost_estimate' => 50,
                'popular_move_months' => 'Peak: Sep-Oct (end of tourism season), Apr (pre-season)',
                'origin_housing_data' => ['avg_price' => '$650,000', 'dominant_type' => 'Apartments & staff housing', 'avg_sqft' => '650'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Narrow Banff townsite streets require careful truck navigation. Park speed limits of 70-90 km/h. Eastbound traffic from Banff is lighter than westbound. Descent through the park is scenic but requires attentive driving for large vehicles.',
                'notable_stops' => 'Canmore, Deadman\'s Flats, Cochrane',
                'backhaul_discount' => false,
                'elevation_change' => '1,383m → 1,045m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 25,
            ],
...
<p><strong>What to expect:</strong> More diverse housing options, shorter commutes to most Calgary workplaces, and access to the city\'s full range of amenities.</p>',
                ...
                'highway_name' => 'Queen Elizabeth II Highway (Highway 2)',
                'highway_number' => 'Highway 2',
                'seasonal_tips' => 'Southbound from Airdrie into Calgary takes 20 minutes. The main challenge is Calgary rush-hour traffic — avoid moving during 7-9 AM and 3:30-6 PM if your destination is in south Calgary. Year-round easy.',
                'fuel_cost_estimate' => 15,
                'popular_move_months' => 'Peak: Jun-Aug, Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$460,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,300'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Short divided highway drive. Merge onto Deerfoot Trail can be congested. For SE/SW Calgary destinations, take Stoney Trail east or west to avoid downtown traffic entirely.',
                'notable_stops' => 'Balzac, CrossIron Mills area',
                'backhaul_discount' => true,
                'elevation_change' => '1,082m → 1,045m (slight descent)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 26,
            ],
...
<p><strong>What to expect:</strong> More housing variety and amenities, shorter commutes to most Calgary workplaces, and easy access back to Cochrane for visits.</p>',
                ...
                'highway_name' => 'Highway 1A / Highway 22',
                'highway_number' => 'Highway 1A/22',
                'seasonal_tips' => 'The drive into Calgary\'s NW is scenic and quick. Morning commuter traffic on Highway 1A can be heavy. Cochrane\'s higher elevation means earlier snowfall — plan November moves carefully. Summer is ideal.',
                'fuel_cost_estimate' => 15,
                'popular_move_months' => 'Peak: May-Sep, Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$520,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,400'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Scenic 2-lane road with rolling hills. Watch for slow-moving farm equipment and horse trailers. The descent into Calgary\'s NW is gentle. Connect to Crowchild Trail or Stoney Trail for destinations beyond NW Calgary.',
                'notable_stops' => 'Bearspaw, NW Calgary communities',
                'backhaul_discount' => false,
                'elevation_change' => '1,152m → 1,045m (descending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 27,
            ],
...
<p><strong>What to expect:</strong> More diverse housing options and a wider range of restaurants, shopping, and entertainment. Calgary\'s south is well-connected by Macleod Trail and Deerfoot Trail.</p>',
                ...
                'highway_name' => 'Highway 2A / Highway 7',
                'highway_number' => 'Highway 2A/7',
                'seasonal_tips' => 'Easy year-round. Northbound into Calgary during morning rush can add 20 minutes if your destination is in north Calgary. The Sheep River valley around Okotoks can have morning frost earlier than Calgary in fall.',
                'fuel_cost_estimate' => 20,
                'popular_move_months' => 'Peak: Jun-Aug, Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$500,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,350'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Smooth 2-lane highway northbound. Light traffic outside of morning commute. Speed enforcement through De Winton remains active. Macleod Trail entry into Calgary is the most direct route to south Calgary destinations.',
                'notable_stops' => 'Heritage Pointe, De Winton',
                'backhaul_discount' => false,
                'elevation_change' => '1,048m → 1,045m (essentially flat)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 28,
            ],
...
<p><strong>What to expect:</strong> More neighbourhood variety, more dining and shopping options, and potentially shorter commutes depending on where you work in Calgary.</p>',
                ...
                'highway_name' => 'Highway 791 / Trans-Canada Highway',
                'highway_number' => 'Highway 791/1',
                'seasonal_tips' => 'Shortest route in our network. The only concern is spring wind gusts off Chestermere Lake affecting tall loads. Year-round easy moving. New subdivisions may have unpaved roads in spring.',
                'fuel_cost_estimate' => 10,
                'popular_move_months' => 'Peak: Jun-Sep, Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$530,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,450'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Quick 15-minute westbound drive. Merge onto Trans-Canada toward Calgary is straightforward. For south Calgary destinations, take Stoney Trail south instead of going through downtown.',
                'notable_stops' => 'East Calgary industrial area',
                'backhaul_discount' => false,
                'elevation_change' => '1,020m → 1,045m (slight ascent)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 29,
            ],
...
<p><strong>What to expect:</strong> Colder, drier winters (but with chinook relief), more affordable housing, no provincial sales tax, and a different but vibrant food and arts scene. Calgarians are famously friendly and the transition from Vancouver is smoother than many expect.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway (Highway 1)',
                'highway_number' => 'Highway 1',
                'seasonal_tips' => 'Eastbound from Vancouver means climbing mountain passes — heavier on fuel and brakes than westbound. Rogers Pass and Kicking Horse Pass require winter tires Oct-Apr. Book 3-4 weeks ahead for summer. Expect a 2-day minimum move.',
                'fuel_cost_estimate' => 450,
                'popular_move_months' => 'Peak: Jun-Sep, Value: Nov-Mar (weather risk)',
                'origin_housing_data' => ['avg_price' => '$1,150,000', 'dominant_type' => 'Condos & apartments', 'avg_sqft' => '850'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Eastbound climbs are demanding for loaded trucks. Multiple mandatory chain-up areas in BC. Rogers Pass summit (1,330m) and Kicking Horse Pass (1,627m) are the critical sections. Stop in Golden or Revelstoke for rest and fuel.',
                'notable_stops' => 'Hope, Kamloops, Revelstoke, Golden, Canmore',
                'backhaul_discount' => true,
                'elevation_change' => '0m → 1,045m (ascending, via mountain passes)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 30,
            ],
...
<p><strong>What to expect:</strong> Colder, drier winters than the Okanagan but more career opportunities and affordable housing. Calgary\'s food, arts, and outdoor recreation scenes are well-developed, and the city\'s energy is contagious.</p>',
                ...
                'highway_name' => 'Highway 97C (Okanagan Connector) / Trans-Canada Highway',
                'highway_number' => 'Highway 97C/1',
                'seasonal_tips' => 'The Okanagan Connector summit (1,728m) is one of BC\'s highest highways — not recommended for winter moves unless absolutely necessary. Spring and fall offer the best balance of weather and availability. Harvest season (Sep-Oct) means wine truck traffic in the Okanagan.',
                'fuel_cost_estimate' => 250,
                'popular_move_months' => 'Peak: May-Sep, Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$620,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,100'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Highway 97C summit at 1,728m is the crux of this route. Eastbound from Kelowna means climbing first, then descending to Merritt and climbing again over the Rockies. Multiple pass crossings make this one of the more demanding routes. Check DriveBC before departure.',
                'notable_stops' => 'Peachland, Merritt, Kamloops, Revelstoke, Golden, Canmore',
                'backhaul_discount' => false,
                'elevation_change' => '344m → 1,045m (via 1,728m summit)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 31,
            ],
...
<p><strong>What to expect:</strong> Milder winters thanks to chinook winds, a stronger job market, more dining and entertainment options, and proximity to world-class mountain recreation. Housing costs are higher but wages tend to be higher too.</p>',
                ...
                'highway_name' => 'Highway 11 / Trans-Canada Highway',
                'highway_number' => 'Highway 11/1',
                'seasonal_tips' => 'Westbound on the prairies means headwinds from the prevailing westerlies — budget extra fuel for loaded trucks. Saskatchewan Highway 11 is monotonous — driver fatigue is a concern. Winter ground blizzards can cause highway closures. Summer is straightforward.',
                'fuel_cost_estimate' => 260,
                'popular_move_months' => 'Peak: May-Sep, Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$330,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,050'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Flat prairie driving for most of the route. Saskatchewan highways can have rough surfaces with frost heaves. The gradual climb into Calgary\'s higher elevation is barely noticeable. Cell coverage is spotty between Swift Current and Medicine Hat.',
                'notable_stops' => 'Rosetown, Swift Current, Medicine Hat, Strathmore',
                'backhaul_discount' => false,
                'elevation_change' => '482m → 1,045m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 32,
            ],
...
<p><strong>What to expect:</strong> Milder winters with chinooks, a vibrant food and arts scene, professional sports teams, and significantly more career and education options. The transition from small-city to big-city living comes with more amenities but also higher housing costs.</p>',
                ...
                'highway_name' => 'Yellowhead Highway (Highway 16) / Highway 2 South',
                'highway_number' => 'Highway 16/2',
                'seasonal_tips' => 'Lloydminster straddles the AB/SK border — confirm your origin address is on the correct side for insurance. Highway 16 west is a flat prairie drive into Edmonton. From Edmonton south, Highway 2 is excellent. Winter ground blizzards on Highway 16 are the main hazard.',
                'fuel_cost_estimate' => 195,
                'popular_move_months' => 'Peak: Apr-Oct (oil & gas), Value: Nov-Mar',
                'origin_housing_data' => ['avg_price' => '$260,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,100'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Highway 16 westbound is mostly 2-lane through flat agricultural land. Heavy oilfield and grain truck traffic. Road quality improves once on Highway 2 south of Edmonton. The full route is a 5-6 hour drive with good conditions.',
                'notable_stops' => 'Vermilion, Vegreville, Edmonton, Red Deer',
                'backhaul_discount' => false,
                'elevation_change' => '668m → 1,045m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
...
<p><strong>What to expect:</strong> More career and education opportunities, higher housing costs but more variety, and a much wider range of restaurants, shopping, and cultural offerings.</p>',
                ...
                'highway_name' => 'Trans-Canada Highway (Highway 1)',
                'highway_number' => 'Highway 1',
                'seasonal_tips' => 'Westbound from Brooks means climbing from prairie to Calgary\'s foothills — loaded trucks will notice the grade. Crosswinds between Brooks and Strathmore can affect tall loads. Summer heat means early morning departures from Brooks are recommended.',
                'fuel_cost_estimate' => 80,
                'popular_move_months' => 'Peak: Apr-Sep, Value: Oct-Mar',
                'origin_housing_data' => ['avg_price' => '$235,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,000'],
                'dest_housing_data' => ['avg_price' => '$540,000', 'dominant_type' => 'Single-family detached', 'avg_sqft' => '1,150'],
                'road_conditions_note' => 'Westbound Trans-Canada is a gradual 290m climb over 190 km. Divided highway in good condition. Limited services between Brooks and Strathmore. Crosswinds are the main hazard on this open prairie stretch.',
                'notable_stops' => 'Bassano, Strathmore',
                'backhaul_discount' => false,
                'elevation_change' => '757m → 1,045m (ascending)',
                'is_bidirectional' => true,
                'is_published' => true,
                'sort_order' => 34,
            ],
