...
use App\Filament\Resources\FrenchPageResource\Pages;
...
class FrenchPageResource extends Resource
{
    protected static ?string $model = FrenchPage::class;
    ...
    protected static ?string $navigationLabel = 'French Pages';
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Section::make('Page Details')->schema([
                ...
                Forms\Components\TextInput::make('english_equivalent_url')->maxLength(255)
                    ->placeholder('/equivalent-english-page'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('h1')->searchable()->limit(40),
                Tables\Columns\TextColumn::make('english_equivalent_url')->limit(30),
    ...
    {
        return [
            'index' => Pages\ListFrenchPages::route('/'),
            'create' => Pages\CreateFrenchPage::route('/create'),
            'edit' => Pages\EditFrenchPage::route('/{record}/edit'),
        ];
    }
}
