    ...
    public function pricing(SchemaMarkupService $schema)
    {
        ...
        $schemas[] = [
            ...
            'mainEntity' => [
                ...
                ['@type' => 'Question', 'name' => 'How do I get an exact quote?', 'acceptedAnswer' => ['@type' => 'Answer', 'text' => 'Request a free quote through our form or call (403) 991-3206. We\'ll ask about your current and new locations, home size, and any special items. Most quotes are provided within 2 hours.']],
