...
@section('meta_description', 'Unitas Movers is Calgary\'s trusted moving company. Licensed, insured, 2,500+ moves completed. Transparent pricing from $99/hr. Call (403) 991-3206.')
@section('schema')
...
<section class="bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        <div class="flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-gray-500">
            ...
            <span class="flex items-center"><svg class="w-4 h-4 text-accent mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>Same-Day Available</span>
        </div>
    </div>
</section>
        ...
        <div class="mt-14">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                @foreach([
                    ...
                    ['icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'title' => 'Same-Day & Last-Minute Moves', 'desc' => 'Need to move fast? We offer same-day and last-minute bookings when crew availability allows. Call us and we\'ll do our best to make it work.'],
                    ['icon' => 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z', 'title' => 'We Treat Your Home Like Our Own', 'desc' => 'Floor runners, door frame padding, furniture blankets on every job. We take every precaution to protect your home and belongings during the move.'],
