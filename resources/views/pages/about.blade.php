@extends('layouts.app')
@section('title', 'About Unitas Movers | Licensed & Insured Movers')
@section('meta_description', 'Learn about Unitas Movers — your trusted, licensed, insured, and affordable moving company. Fast & flexible service, transparent pricing, 2,500+ moves completed.')
@section('schema')
...
<section class="bg-unitas-green py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-3xl lg:text-4xl font-serif font-bold text-white">About Unitas Movers</h1>
...
<section class="py-12 lg:py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg max-w-none">
            <h2>Our Story</h2>
            <p>Unitas Movers was founded with a simple mission: provide Calgary families and businesses with reliable, honest, and affordable moving services. We believe that a great move starts with great people, transparent pricing, and respect for your belongings.</p>
        ...
        <div class="mt-12 bg-forest rounded-xl p-8 text-center">
            <h2 class="text-2xl font-serif font-bold text-white">Ready to Experience the Unitas Difference?</h2>
