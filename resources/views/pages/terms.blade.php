@extends('layouts.app')
@section('title', 'Terms of Service | Alpine Movers Calgary')
@section('schema')
...
<section class="py-12 lg:py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg max-w-none">
            ...
            <p>By booking moving services with Alpine Movers Calgary, you agree to these terms and conditions. A confirmed booking constitutes a binding agreement between you and Alpine Movers.</p>
            ...
            <h2>Liability</h2>
            <p>Alpine Movers carries comprehensive liability insurance. Claims must be reported within 24 hours of move completion. We are not responsible for items packed by the customer unless a packing service was purchased.</p>
            <h2>Contact</h2>
            <p>For questions about these terms, contact us at info@alpinemovers.ca or call (403) 800-2747.</p>
        </div>
    </div>
</section>
@endsection
