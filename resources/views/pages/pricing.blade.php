@extends('layouts.app')
@section('title', 'Moving Prices Calgary | Transparent Pricing | Unitas Movers')
...
<section class="py-12 lg:py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="overflow-x-auto">
            <table class="w-full bg-white rounded-xl shadow-sm border border-stone/10">
                ...
                <tbody class="divide-y divide-stone/10">
                    <tr><td class="py-4 px-6">Studio / Bachelor</td><td class="py-4 px-6 text-stone">2–3 hours</td><td class="py-4 px-6 font-semibold text-unitas-green">$350 – $550</td></tr>
                    <tr><td class="py-4 px-6">1 Bedroom</td><td class="py-4 px-6 text-stone">3–4 hours</td><td class="py-4 px-6 font-semibold text-unitas-green">$500 – $750</td></tr>
                    <tr><td class="py-4 px-6">2 Bedrooms</td><td class="py-4 px-6 text-stone">4–6 hours</td><td class="py-4 px-6 font-semibold text-unitas-green">$750 – $1,200</td></tr>
                    <tr><td class="py-4 px-6">3 Bedrooms</td><td class="py-4 px-6 text-stone">6–8 hours</td><td class="py-4 px-6 font-semibold text-unitas-green">$1,200 – $1,800</td></tr>
                    <tr><td class="py-4 px-6">4+ Bedrooms</td><td class="py-4 px-6 text-stone">8–10 hours</td><td class="py-4 px-6 font-semibold text-unitas-green">$1,800 – $2,500+</td></tr>
                    <tr><td class="py-4 px-6">Office / Commercial</td><td class="py-4 px-6 text-stone">Custom</td><td class="py-4 px-6 font-semibold text-unitas-green">Contact Us</td></tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('quote.create') }}" class="inline-block bg-unitas-green hover:bg-forest text-white px-8 py-4 rounded-lg font-bold text-lg transition shadow-lg">Get Your Exact Quote</a>
        </div>
    </div>
</section>
@endsection
