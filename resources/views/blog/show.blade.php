...
<section class="py-12 lg:py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    @foreach($relatedPosts as $related)
                        <a href="{{ route('blog.show', $related) }}" class="group bg-white rounded-xl p-5 shadow-sm hover:shadow-md border border-stone/10 transition">
                            ...
                            <h3 class="mt-2 font-semibold text-slate-dark group-hover:text-alpine-green transition">{{ $related->title }}</h3>
                        </a>
                    @endforeach
                </div>
            </div>
        ...
        <div class="mt-12 bg-forest rounded-xl p-8 text-center">
            ...
            <p class="mt-2 text-white/80">Get a free, no-obligation quote from Alpine Movers today.</p>
