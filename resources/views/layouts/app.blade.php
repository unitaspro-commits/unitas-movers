...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@300;400;500;600;700;800&family=Montserrat:wght@500;600;700&family=Inter:wght@300;400;500;600;700&family=Fragment+Mono&display=swap" rel="stylesheet">
...
<body class="bg-white text-dark font-sans antialiased">
    ...
    <div class="fixed bottom-24 lg:bottom-8 right-4 lg:right-6 z-50" x-data="{ open: false }">
        {{-- Chat Panel --}}
        <div x-show="open" x-transition:enter="transition ease-out duration-300"
             ...
             class="mb-4 bg-white rounded-2xl shadow-2xl border border-gray-200 w-80 overflow-hidden">
            ...
            <div class="p-4">
                <div class="bg-gray-50 rounded-xl p-3 mb-3">
                    <p class="text-sm text-dark">Hi there! Need help with your move? We're here to answer any questions.</p>
                </div>
                <div class="space-y-2">
                    <a href="tel:+14038002747" class="flex items-center space-x-3 p-3 rounded-xl border border-gray-100 hover:border-primary/20 hover:bg-primary-50 transition group">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-dark">Call Us</p>
                            <p class="text-xs text-gray-500">(403) 800-2747</p>
                        </div>
                    </a>
                    <a href="{{ route('quote.create') }}" class="flex items-center space-x-3 p-3 rounded-xl border border-gray-100 hover:border-primary/20 hover:bg-primary-50 transition group">
                        <div class="w-8 h-8 bg-primary-50 group-hover:bg-primary rounded-lg flex items-center justify-center shrink-0 transition-colors">
                            <svg class="w-4 h-4 text-primary group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-dark">Get Free Quote</p>
        ...
        {{-- Chat Button --}}
        <button @click="open = !open" class="chat-widget w-14 h-14 bg-primary hover:bg-primary-dark rounded-full shadow-[0_4px_20px_rgba(89,52,255,0.4)] flex items-center justify-center transition-all group relative">
            <svg x-show="!open" class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
            <svg x-show="open" class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
            <span class="chat-widget-tooltip absolute right-full mr-3 bg-dark text-white text-xs font-semibold px-3 py-1.5 rounded-lg whitespace-nowrap">Chat with us</span>
            <span class="absolute -top-1 -right-1 w-4 h-4 bg-accent rounded-full border-2 border-white" x-show="!open"></span>
        </button>
    </div>
